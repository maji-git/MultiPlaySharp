...
public partial class WebSocketNetProtocol : MPNetProtocolBase
{
...
public X509Certificate SslCertificate {
            ...
            public new static WebSocketNetProtocol GetFromNode(Node node)
            {
                WebSocketNetProtocol n = new WebSocketNetProtocol();
